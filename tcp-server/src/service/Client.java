...
//                onReceiveLeaveRoom("");
    ...
    private void onReceiveGetScoreRanking() {
        String rankingResult = new UserController().getRanking();

        if (rankingResult.startsWith("error")) {
            sendData("GET_SCORE_RANKING" + ";" + "failed; Unable to retrieve ranking.");
            return;
        }

        sendData("GET_SCORE_RANKING" + ";" + "success;" + rankingResult);
    }
